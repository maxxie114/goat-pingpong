 ...
 */
export async function signTypedData(signer, signRequest) {
 ...
 */
export function hashCalldata(calldata) {
 ...
 */
export function verifySignature(signRequest, signature, expectedSigner) {
    try {
        const domain = signRequest.domain;
        const message = signRequest.message;
        // Filter out EIP712Domain from types - ethers v6 handles it automatically
